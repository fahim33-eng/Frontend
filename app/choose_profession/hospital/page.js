    ...
    <main className="min h-screen overflow-y-scroll p-8 flex flex-col items-center bg-gradient-to-r from-[#40a1ce] to-[#bfecfa]">
      ...
      <div>
        ...
        <div className='flex my-4 bg-[#f0f0f0] space-x-4 shadow-md rounded-full px-4 py-2 items-center'>
            <input required className='bg-transparent w-full focus:outline-none' onChange={e => setHospitalName(e.target.value)} type="text" placeholder="Your Hospital Name" value={hospitalName}/>
        </div>
        <div className='flex bg-[#f0f0f0] space-x-4 shadow-md rounded-full px-4 py-2 items-center'>
        ...
        <div className="space-x-4">
          <label className="my-4 bg-[#f0f0f0] space-x-4 shadow-md rounded-full px-4 py-2 text-gray-500" htmlFor="city">Which City The Hospital is Situated In : </label>
        ...
        <div className='my-4 h-[4rem] flex-wrap bg-[#f0f0f0] space-x-4 shadow-md rounded-lg px-4 py-2'>
            <input className='bg-transparent h-full w-full overflow-auto text-start focus:outline-none flex-wrap' onChange={e => setDescription(e.target.value)} type="description" placeholder="Tell Us A Little Bit About Your Hospital" value={description}/>
        </div>
      </div>
      <div className='my-4 space-x-4 shadow-md rounded-lg px-4 py-2'>
          <div className="flex justify-between space-x-8">
            <label className="font-semibold" htmlFor="imageInput">Upload Your Hospital's Image Here :</label>
